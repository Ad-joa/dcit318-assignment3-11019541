...
namespace InventorySystem
{
    ...
    public class InventoryApp
    {
        ...
        public void SeedSampleData()
        {
            ...
            _logger.Add(new InventoryItem(2, "Flash Drive", 20, DateTime.Now));
            _logger.Add(new InventoryItem(3, "Mouse", 15, DateTime.Now));
            _logger.Add(new InventoryItem(4, "Keyboard", 10, DateTime.Now));
            _logger.Add(new InventoryItem(5, "Monitor", 7, DateTime.Now));
        }
    ...
    class Program
    {
        static void Main()
        {
            ...
            // Clear memory and simulate fresh session
